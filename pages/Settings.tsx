  ...
  return (
    <div className="max-w-5xl mx-auto w-full min-h-screen p-6 md:p-8 flex flex-col">
      ...
      <div className="mt-12 pt-6 border-t border-gray-200 dark:border-slate-700">
         <button className="w-full bg-red-50 hover:bg-red-100 text-red-600 dark:bg-red-900/10 dark:hover:bg-red-900/20 dark:text-red-400 font-medium py-3 rounded-xl transition-colors border border-red-200 dark:border-red-900/30 flex items-center justify-center gap-2">
