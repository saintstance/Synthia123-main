    ...
    <div className="p-6 md:p-8 bg-gray-100 dark:bg-slate-900 h-full overflow-y-auto">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-md p-6 md:p-8 mb-6">
        <div className="flex flex-col md:flex-row items-start md:items-center space-y-4 md:space-y-0 md:space-x-6">
          ...
          <img src="https://i.pinimg.com/1200x/35/69/30/3569309bfbce2565ff6c83dff214b4c7.jpg" alt="Profile" className=" rounded-full border border-gray-200 dark:border-slate-600" />
            </div>
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center space-x-2 mt-1">
              <span className="text-gray-600 dark:text-slate-400 font-medium">Software Engineer at ATI</span>
            </div>
          </div>
